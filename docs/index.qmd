...
- [YARR! The Pirate’s Guide to R](https://nathanieldphillips-yarrr.share.connect.posit.cloud/) (FREE)
...
- They have a course called [R You With me](https://rladiessydney.org/courses/) - fantastic for beginners! (Alycia recommends)
...
- Download from [https://cran.csiro.au/](https://cran.csiro.au/)
...
::: fragment
```{r trim mean demo, include = TRUE, echo=TRUE}
#| output-location: fragment
score <- c( 3, 2, 1, 5, 7,
12, 3, 1, 4, 10000 )
 mean( score )
...
```{r flexplot histogram, include = TRUE, echo=TRUE}
#| output-location: fragment
#| fig-width: 7
#| fig-height: 4
library(flexplot)
